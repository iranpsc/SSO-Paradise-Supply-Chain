            ...
            <div class=" rounded-xl p-6 md:p-8">
                ...
                <div class="flex justify-center mt-6 gap-2">
                    <button type="button" id="connect-wallet-btn" onclick="connectWallet()"
                        ...
                        <svg id="wallet-spinner" class="hidden animate-spin h-5 w-5 text-gray-800 dark:text-gray-100"
                    ...
                    <button type="button" id="connectWallet-btn" onclick="connectWalletBtn()"
                        class="w-full bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-200 dark:border-slate-700 rounded-lg px-4 py-3 flex items-center justify-center gap-2 transition focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
                        <svg id="connectWallet-icon" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-yellow-500"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M21 7v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h14a2 2 0 012 2z" />
                            <circle cx="12" cy="12" r="4" fill="#f59e42" />
                        </svg>
                        <svg id="connectWallet-spinner"
                ...
                @if ($errors->has('wallet'))
                    <p class="mt-4 text-center text-sm text-red-600 dark:text-red-400">{{ $errors->first('wallet') }}
                    </p>
                @endif
                <script>
                    const isMobile =
        ...
        <script type="application/ld+json">
{
    ...
    "@@graph": [
        {
            "@@type": "Organization",
            "@@id": "https://accounts.irpsc.com/#organization",
            "name": "تونل زمان",
            "url": "https://accounts.irpsc.com",
            "@@logo": {
                "@@type": "ImageObject",
                "url": "https://accounts.irpsc.com/images/logo/accounts.png"
            },
            "description": "سامانه مدیریت حساب کاربری IRPSC که امکان ورود امن و سریع به سرویس‌ها و خدمات آنلاین را فراهم می‌کند. کاربران می‌توانند با استفاده از این سامانه حساب کاربری خود را مدیریت کرده و با یک بار ورود به خدمات متصل دسترسی داشته باشند.",
            "email": "Cq@irpsc.com",
        ...
        {
            "@@type": "WebSite",
            "@@id": "https://accounts.irpsc.com/#website",
            "url": "https://accounts.irpsc.com",
            "name": "تونل زمان",
            "description": "سامانه مدیریت حساب کاربری IRPSC",
            "publisher": {
                "@@id": "https://accounts.irpsc.com/#organization"
            },
            "inLanguage": "fa-IR"
        ...
        {
            "@@type": "WebPage",
            "@@id": "https://accounts.irpsc.com/login#webpage",
            "url": "https://accounts.irpsc.com/login",
            "name": "ورود به حساب کاربری",
            "description": "ورود به سامانه مدیریت حساب کاربری IRPSC با استفاده از ایمیل یا نام کاربری و رمز عبور.",
            "isPartOf": {
                "@@id": "https://accounts.irpsc.com/#website"
            },
            "about": {
