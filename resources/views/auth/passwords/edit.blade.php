    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('password.new') }}">
            <div class="flex flex-col gap-7 w-full xl:w-1/2 2xl:w-[40%] mx-auto">
                ...
                <x-form.text :label="__('Current Password')" for="current_password" name="current_password" type="current_password" requried/>

                <x-form.text :label="__('New Password')" for="password" name="password" type="password" required/>

                <x-form.text :label="__('Confirm New Password')" for="password_confirmation" name="password_confirmation" type="password" required/>
