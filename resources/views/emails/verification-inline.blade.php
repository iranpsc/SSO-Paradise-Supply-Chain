                        ...
                        <td style="padding:30px 30px 10px 30px;">
                            ...
                            <div style="background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:6px;padding:15px;margin:0 0 20px 0;">
                                ...
                                <ul style="margin:0;padding:0 {{ $isRtl ? '0 20px 0 0' : '0 0 0 20px' }};list-style:disc;">
                                    <li style="margin:0 0 8px 0;">{{ __('This verification link will expire in :minutes minutes for your security', ['minutes' => $expireTime ?? 60]) }}</li>
                                    <li style="margin:0 0 8px 0;">{{ __('If you did not register for an account with us, no action is required') }}</li>
                                    <li style="margin:0;">{{ __('Never share this verification link with anyone') }}</li>
                                </ul>
                            </div>
                            ...
                            <div style="background-color:#f8f9fa;padding:15px;margin:0 0 25px 0;border-{{ $isRtl ? 'right' : 'left' }}:4px solid #007bff;">
                                ...
                                <ol style="margin:0;padding:0 {{ $isRtl ? '0 20px 0 0' : '0 0 0 20px' }};">
                                    <li style="margin:0 0 8px 0;">{{ __('Click the button below to verify your email address') }}</li>
